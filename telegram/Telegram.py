...
if(S == 'S' or S =='s'):
    ...
    vectorStore = Chroma(embedding_function=FastEmbedEmbeddings(model_name='intfloat/multilingual-e5-large',
                                    cache_dir="/home/tcc_rag/.cache/huggingface/hub/") ,persist_directory='./db_9')
